...
<html lang="es">
  ...
  <!-- Cargos de Gestion -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-0" for="pwd">Cargo/s Gesti&oacute;n:</label>
      <div class="col-sm-20">          
        <input type="text" class="form-control" id="CargosGestion" placeholder="Ingresar su cargo de gestion">
      </div>
    </div>
