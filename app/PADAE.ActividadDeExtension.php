...
<html>
    <head>
        ...
        $(document).ready(function(){
            ...
            $('#btn_add_ActividadNOPADA').click(function(){
                agregarActividadNOPADA();
            });
            $('#btn_del_ActividadNOPADA').click(function(){
                eliminarActividadNOPADA();
            });
        ...
        function agregarActividadNOPADA(){
            cont2++;
            var fila= '<tr id="filaNOPADA'+cont2+'"><td><input type="text" placeholder="Publicacion realizada" class="form-control" id="ActividadDeExtension_Publicacion" name="ActividadDeExtension_Publicacion"/>\n\
            </td><td><select class="form-control" id="Dedicacion"><option>Responsable</option><option>Integrante</option>\n\
            <option>Colaborador</option><option>Dictante</option></select></td><td><input type="number" class="form-control" placeholder="Cantidad semanal" /> \n\
            </td><td><select class="form-control" id="Dedicacion"><option>Anual</option><option>Cuatrimestral</option></select></td></tr>';
            $('#tablaActividadPADAENOPADA').append(fila);
        }
        function eliminarActividadNOPADA(){
            $('#filaNOPADA'+cont2).remove();
            cont2--;
        }
        function agregarPublicacionPADAE(){
            ...
            </td><td><input type="text" placeholder="Divulgación...Técnica...otro" class="form-control" id="ActividadDeExtension_Calidad" name="ActividadDeExtension_Calidad"/>\n\
  ...
  <div class="w3-bar w3-margin-bottom">
    ...
    &nbsp;&nbsp;&nbsp;
    <a class="w3-bar-item w3-btn" href="PADAE.ActividadDeExtension.php" style="color:red;">2 - Actividad de Extensión »</a>
    &nbsp;&nbsp;&nbsp;
        ...
        <div class="container" >  
            ...
            <div class="card">
                     <table class='table table-bordered table-hover'>
                         ...
                         <tr>
                             <td>
                                 <input type="text" placeholder="Para ser utilizado en la evaluacion de desempeño" class="form-control" id="ActividadDeExtension_Otro" name="ActividadDeExtension_Otro"/>
                             </td>
                             <td>
            ...
            <label class="form-inline">
                    <h4>Actividad de Extensión No Previstas en el PADA:</h4>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" class='btn btn-primary' id="btn_add_ActividadNOPADA">Nueva Actividad</button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" class='btn btn-danger' id="btn_del_ActividadNOPADA">Eliminar Actividad</button>
                  </label>
            <div class="card">
                  <table class='table table-bordered table-hover' id="tablaActividadPADAENOPADA">
                    <tr>
                      <th>Proyecto/Programa:</th>
                      <th>Calidad:</th>
                      <th>Hs Asignadas:</th>
            ...
            <div class="card">
                     <table class='table table-bordered table-hover' id="TablaPublicaciones">
                         ...
                         <tr>
                             ...
                             <td>
                                 <input type="text" placeholder="Divulgación...Técnica...otro" class="form-control" id="ActividadDeExtension_Calidad" name="ActividadDeExtension_Calidad"/>
                            </td>
                             <td>
