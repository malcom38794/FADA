                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>
                            ...
                            Tenga en cuenta que solo podr&aacute; modificar la secci&oacute;n de actividad docente.
                        </p>
                           <p>
                        <a href="PADAEVO.Gestion.php">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>
                            ...
                            formularios P.A.D.A.E. (Plan Anual De Actividades Ejecutado).<br>
                            Entregados por los docentes con su correspondiente firma.
                        </p>
                           <p>
                        <a href="PADAE.Entrega.php">
                        <button type="button" class="btn btn-success">
