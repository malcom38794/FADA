            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td><a href="PADAEVO.Extension.php">
        ...
        <!-- Botones Orden -->
            ...
            <div>
                <a href="PADA.ActividadDocente.php">
                   <button type="button" class="btn btn-success">
                       <span class="oi oi-arrow-circle-top"></span> P.A.D.A.E. Entregado
                     </button>
                 </a>
                <br> <br>
                ...
                <a href="PantallaDocentes.php">
                <button type="button" class="btn btn-info">
                       <span class="oi oi-arrow-circle-top"></span> P.A.D.A.E.V.O. Cargado
                    </button>
                </a>
                <br> <br>
                <a href="PantallaDocentes.php">
